...
void searchData()
{
	...
	Node* prev, * curr;
	prev = curr = NULL;
	cout << "\nEmter the roll number of the student whose record you want to search: ";
	int num;
	cin >> num;
...
int main()
{
		...
		
	{
		try
		{
			...
			cout << "3. View all records in the asceding order of roll numbers" << endl;
			cout << "4. View all records iint he descending order of roll numbers" << endl;
